...
from ejemplo.forms import Buscar, FamiliarForm, AutomovilForm, MascotaForm
...
def mostrar_automoviles(request):
    ...
    return render(request, "ejemplo/automoviles.html", {"lista_automoviles": automoviles})
